...
public class OperationPutRequestBodyDeserializer extends UllJsonDeserializer<OperationPutRequestBody> {
    ...
    public OperationPutRequestBody parse(JsonNode operationNode) {
        validate(operationNode);
        OperationPutRequestBody parsedRequest = new OperationPutRequestBody();

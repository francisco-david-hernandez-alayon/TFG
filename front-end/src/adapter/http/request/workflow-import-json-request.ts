...
export class WorkFlowImportJsonRequest {
    public uuid: string;
    ...
    static toRequest(exportFile: ExportFile): WorkFlowImportJsonRequest {
        const workFlow = exportFile.getWorkFlow();
        ...
        return new WorkFlowImportJsonRequest(uuid, workFlowName, enabled, creationDate, nodeDtos);
    }

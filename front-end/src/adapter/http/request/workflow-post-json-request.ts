...
export class WorkFlowPostJsonRequest {
    ...
    static toRequest(workFlow: WorkFlow): WorkFlowPostJsonRequest {
        ...
        return new WorkFlowPostJsonRequest(workFlowName, enabled, nodeDtos);
    }

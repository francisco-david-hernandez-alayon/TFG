...
interface Props {
  name: 'reset' | 'update' | 'sun' | 'moon' | 'log'
}
...
<template>
  ...
  <svg v-else-if="props.name === 'update'" width="16" height="16" viewBox="0 0 24 24">
    <path
  ...
  <svg v-else-if="props.name === 'sun'" width="16" height="16" viewBox="0 0 24 24">
    <path
  ...
  <svg v-else-if="props.name === 'moon'" width="16" height="16" viewBox="0 0 24 24">
    <path
